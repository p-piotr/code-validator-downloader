...
define('CODE_RESULT_INVALID_DEFAULT_COMMENT', '<a style="font-size: 20px; color: #000000">Twój numer seryjny jest pusty lub zawiera nielegalne znaki</a>');
...
$client_comments_array = array(
    ...
    'CODE_RESULT_INVALID' => CODE_RESULT_INVALID_DEFAULT_COMMENT,
