...
function add_code_from_file($file_path)
{
    ...
    {   $single_code_array = array();
        ...
        $single_code_array['serial_code'] = $code_params[0];
...
function add_download_log($serial_code, $product_id, $package_id, $visitor_ip, $date_time, $user_agent, $ctd)
{
    require_once(ABSPATH . 'wp-admin/includes/upgrade.php');
    ...
    return $wpdb->insert($table_name_downloads,
        ...
        'package_id' => $package_id, 'visitor_ip' => $visitor_ip, 'date_time' => $date_time,
