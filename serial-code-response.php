...
function invalid_serial_code_invalid()
{
    global $client_comments_array;
    return '<div style="width: 100%; text-align: center;">' . $client_comments_array['CODE_RESULT_INVALID'] . '</div>';
}
